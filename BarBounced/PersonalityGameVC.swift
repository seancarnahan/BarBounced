...
class PersonalityGameVC: UIViewController {
    var gameMessages = [
        ...
        "That Really Personal Person": ["The Really Personal Card game USER",true] ,
        "The medium" : ["The medium card game",false],
        "The Mr. Worldwide":  ["The Mr. Worldwide Card game",false],
        "The Drug Dealer": ["The Drug Dealer Card game USER",true] ,
        "The Conservationist": ["The Conservationist Card game",false] ,
        "The anonymous": ["The anonymous card game",false],
        "The Nicotine Fiend": ["The Nicotine Fiend game",false] ,
        "The Proposer":  ["The Marriage Proposal Card game",false],
        "The Judgement day":  ["The Judgement day Card game USER",true],
        "The Ray Charles Cousin": ["The Ray Charles Cousin Card game USER",true] ,
        "The Magician": [ "The Self Centered Role game",false],
        "The Self Centered Role":  ["The Self Centered Role game USER",true],
        "The Average Size": ["The Average Size Card game USER",true] ,
        "The Where do I know you from guy":  ["The Where do I know you from card game USER",true],
        "Young Entrepreneur": ["Young Entrepreneur Card game USER",true] ,
        "The Lumberjack": ["The Lumberjack Card game USER",true] ,
    ...
    var barPersonMessages = [
        ...
        "That Really Personal Person":"You have to ask about their most recent death, or just start rambling about yours and say how a depressed sack of shit you are",
        "The medium":"Must explain that you can talk to the dead and see the future, during your conversations show off your skills",
        "The Mr. Worldwide": "Must say 'Delé' after each sentence, unironically",
        "The Drug Dealer": "Must offer drugs during each conversation but must use words/slang no one will understand. Exp. 'Wanna soar this bird",
        "The Conservationist": "Must bring up how the global climate crisis is the only topic you can converse about and if any other topic comes up, then you must consider them an earth hater",
        "The anonymous":"Must never give your real name to anybody, the group you are playing with will assign you with new names that you have to go with for the rest of the night",
        ...
        "The Proposer": "Must propose to a friend/stranger in front of everyone",
        "The Judgement day":"Must ask at least 20 people to rate them on their looks on a scale of 1-10",
        "The Ray Charles Cousin":"You are now Ray Charles cousin and you have to mention how your cousin was so talented and you wish he wasn't blind and how you're a better piano player because you can see.  Stop questioning this card, you picked it, don't put this on me",
        "The Magician":"must perform a magic trick to each person they meet, the magic doesn't have to work, that's what makes it magic",
        ...
        "The Average Size":"Must acknowledge how mediocre is the best of the best.  Talk about how your average size penis is the best.  Good luck with this one bud",
        "The Where do I know you from guy":"Must go up to strangers and ask them where you know them from.  Get offended if they do not remember you",
        "Young Entrepreneur":"Must talk about how you have multiple forms of passive income and that college isn't for you and a waste of time but you are very must interested in gaining knowledge.  You live at your parents home",
        "The Lumberjack":"Must wear a flannel and button it up all the way, beard"
    ]
